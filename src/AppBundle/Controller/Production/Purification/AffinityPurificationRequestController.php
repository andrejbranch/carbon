...
class AffinityPurificationRequestController extends CarbonApiController
{
    /**
     * @var string The namespace of the resource entity
     */
    const RESOURCE_ENTITY = "AppBundle\Entity\Production\Purification\AffinityPurificationRequest";

    /**
     * @var string The form type for this resource
     */
    const FORM_TYPE = "AffinityPurification";
    ...
    protected $security = array(
        ...
        'PUT' => array(
            'roles' => array('ROLE_AFFINITY_ADMIN'),
            'allow_creator' => true,
        ),
        'DELETE' => array(
            'roles' => array('ROLE_AFFINITY_ADMIN'),
    ...
    /**
     * @Route("/production/purification/affinity-purification-request", name="production_affinity_purification_request_get")
     * @Method("GET")
     *
     * @return Response
     */
     ...
     *
     * @Route("/production/purification/affinity-purification-request", name="production_affinity_purification_request_post")
     * @Method("POST")
     *
     * @return Response
     */
     ...
     * @Route("/production/purification/affinity-purification-request", name="production_affinity_purification_request_put")
     * @Method("PUT")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/purification/affinity-purification-request/{requestId}/download-output-template/{sampleCount}", name="production_affinity_purification_request_output_template_download")
     * @Method("GET")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/purification/affinity-purification-request/{purificationRequestId}/complete", name="production_affinity_purification_request_complete")
     * @Method("POST")
     *
     * @return Response
     */
