...
class NativeGelRequestController extends CarbonApiController
{
    /**
     * @var string The namespace of the resource entity
     */
    const RESOURCE_ENTITY = "AppBundle\Entity\Production\Analysis\NativeGelRequest";
     ...
     *
     * @Route("/production/analysis/native-gel-request", name="production_native_gel_request_post")
     * @Method("POST")
     *
     * @return Response
     */
     ...
     * @Route("/production/analysis/native-gel-request", name="production_native_gel_request_put")
     * @Method("PUT")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/native-gel-request/{requestId}/download-output-template/{sampleCount}", name="production_native_gel_request_output_template_download")
     * @Method("GET")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/native-gel-request/{purificationRequestId}/complete", name="production_native_gel_request_complete")
     * @Method("POST")
     *
     * @return Response
     */
