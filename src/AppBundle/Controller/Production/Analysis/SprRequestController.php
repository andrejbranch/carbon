...
class SprRequestController extends CarbonApiController
{
    /**
     * @var string The namespace of the resource entity
     */
    const RESOURCE_ENTITY = "AppBundle\Entity\Production\Analysis\SprRequest";
     ...
     *
     * @Route("/production/analysis/spr-request", name="production_spr_request_post")
     * @Method("POST")
     *
     * @return Response
     */
     ...
     * @Route("/production/analysis/spr-request", name="production_spr_request_put")
     * @Method("PUT")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/spr-request/{requestId}/download-output-template/{sampleCount}", name="production_spr_request_output_template_download")
     * @Method("GET")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/spr-request/{purificationRequestId}/complete", name="production_spr_request_complete")
     * @Method("POST")
     *
     * @return Response
     */
