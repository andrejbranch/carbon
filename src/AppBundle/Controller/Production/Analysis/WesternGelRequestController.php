...
class WesternGelRequestController extends CarbonApiController
{
    /**
     * @var string The namespace of the resource entity
     */
    const RESOURCE_ENTITY = "AppBundle\Entity\Production\Analysis\WesternGelRequest";
     ...
     *
     * @Route("/production/analysis/western-gel-request", name="production_western_gel_request_post")
     * @Method("POST")
     *
     * @return Response
     */
     ...
     * @Route("/production/analysis/western-gel-request", name="production_western_gel_request_put")
     * @Method("PUT")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/western-gel-request/{requestId}/download-output-template/{sampleCount}", name="production_western_gel_request_output_template_download")
     * @Method("GET")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/western-gel-request/{purificationRequestId}/complete", name="production_western_gel_request_complete")
     * @Method("POST")
     *
     * @return Response
     */
