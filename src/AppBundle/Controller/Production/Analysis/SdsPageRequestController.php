...
class SdsPageRequestController extends CarbonApiController
{
    /**
     * @var string The namespace of the resource entity
     */
    const RESOURCE_ENTITY = "AppBundle\Entity\Production\Analysis\SdsPageRequest";
     ...
     *
     * @Route("/production/analysis/sds-page-request", name="production_sds_page_request_post")
     * @Method("POST")
     *
     * @return Response
     */
     ...
     * @Route("/production/analysis/sds-page-request", name="production_sds_page_request_put")
     * @Method("PUT")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/sds-page-request/{requestId}/download-output-template/{sampleCount}", name="production_sds_page_request_output_template_download")
     * @Method("GET")
     *
     * @return Response
     */
    ...
    /**
     * @Route("/production/analysis/sds-page-request/{purificationRequestId}/complete", name="production_sds_page_request_complete")
     * @Method("POST")
     *
     * @return Response
     */
