...
/**
 * @ORM\Entity()
 * @ORM\Table(name="production.purification_request_project", schema="production")
 */
class PurificationRequestProject
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Project", inversedBy="purificationRequestProjects")
