 ...
 *
 * @ORM\Entity()
 * @ORM\Table(name="production.size_exclusion_purification_request_input_sample", schema="production")
 */
class SizeExclusionPurificationRequestInputSample implements BaseRequestSampleInterface
{
    /**
     * @var integer
     *
