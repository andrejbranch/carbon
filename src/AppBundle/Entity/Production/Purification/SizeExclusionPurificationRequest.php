...
/**
 * @ORM\Entity()
 * @ORM\Table(name="production.size_exclusion_purification_request", schema="production")
 * @Gedmo\Loggable
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 */
class SizeExclusionPurificationRequest extends BaseRequest
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production\Purification\SizeExclusionPurificationRequestInputSample", mappedBy="request")
     */
    protected $inputSamples;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production\Purification\SizeExclusionPurificationRequestOutputSample", mappedBy="request")
     */
    protected $outputSamples;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production\Purification\SizeExclusionPurificationRequestProject", mappedBy="purificationRequest")
     */
