...
/**
 * @ORM\Entity()
 * @ORM\Table(name="production.size_exclusion_purification_request_output_sample", schema="production")
 */
class SizeExclusionPurificationRequestOutputSample implements BaseRequestSampleInterface
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Production\Purification\SizeExclusionPurificationRequest")
