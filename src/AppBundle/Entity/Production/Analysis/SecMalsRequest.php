...
/**
 * @ORM\Entity()
 * @ORM\Table(name="production.sec_mals_request", schema="production")
 * @Gedmo\Loggable
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 */
class SecMalsRequest extends BaseRequest
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production\Analysis\SecMalsRequestInputSample", mappedBy="request")
     */
    protected $inputSamples;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production\Analysis\SecMalsRequestProject", mappedBy="request")
     */
