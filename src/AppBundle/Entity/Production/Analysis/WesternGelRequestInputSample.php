...
/**
 * @ORM\Entity()
 * @ORM\Table(name="production.western_gel_request_input_sample", schema="production")
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 */
class WesternGelRequestInputSample implements BaseRequestSampleInterface
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Production\Analysis\WesternGelRequest")
