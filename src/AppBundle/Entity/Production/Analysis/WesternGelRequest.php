...
/**
 * @ORM\Entity()
 * @ORM\Table(name="production.western_gel_request", schema="production")
 * @Gedmo\Loggable
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 */
class WesternGelRequest extends BaseRequest
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production\Analysis\WesternGelRequestInputSample", mappedBy="request")
     */
    protected $inputSamples;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production\Analysis\WesternGelRequestProject", mappedBy="request")
     */
