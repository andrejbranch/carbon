...
/**
 * @ORM\Entity()
 * @ORM\Table(name="production.native_gel_request_input_sample", schema="production")
 */
class NativeGelRequestInputSample implements BaseRequestSampleInterface
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Production\Analysis\NativeGelRequest")
