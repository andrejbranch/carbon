...
class PlayerCard
{
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Player", inversedBy="playerCards")
     * @ORM\JoinColumn(name="player_id", nullable=false)
     * @JMS\MaxDepth(1)
     * @var AppBundle\Entity\Player the player object that owns the linked card
     */
    protected $player;

    /**
     * @ORM\Id
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Card")
     * @ORM\JoinColumn(name="card_id", nullable=false)
     * @var AppBundle\Entity\Card the card object
     */
    protected $card;
