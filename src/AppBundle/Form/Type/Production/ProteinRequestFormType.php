...
class ProteinRequestFormType extends CryoblockAbstractType
{
    private $class;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('projects', 'cryoblock_mtm', array(
                ...
                'accessor' => 'proteinRequestProjects',
                'child_accessor' => 'project'
            ))

            ->add('samples', 'cryoblock_mtm', array(
                'parent_object' => $builder->getForm()->getData(),
                'accessor' => 'proteinRequestSamples',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\Production\ProteinRequest',
