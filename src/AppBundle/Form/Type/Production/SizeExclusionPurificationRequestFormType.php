...
class SizeExclusionPurificationRequestFormType extends CryoblockAbstractType
{
    private $class;
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\Production\Purification\SizeExclusionPurificationRequest',
    ...
    {
        return 'SizeExclusionPurification';
    }
}
